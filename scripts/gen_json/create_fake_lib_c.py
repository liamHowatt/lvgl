...
lib_c_files = (
    ...
    ('limits.h', None, ''),
    ('locale.h', None, ''),
    ('malloc.h', None, 'void *malloc(size_t size);\nvoid *realloc(void *memblock, size_t size);\nvoid free(void *memblock);'),
    ('math.h', None, ''),
    ('memory.h', None, 'void *memset(void *dest, int c, size_t count);\nvoid *memcpy(void *dest, const void *src, size_t count);\nint memcmp(const void *buffer1, const void *buffer2, size_t count);'),
    ('monetary.h', None, ''),
    ('mqueue.h', None, ''),
    ('ndbm.h', None, ''),
    ('netdb.h', None, ''),
    ...
    ('stdlib.h', None, ''),
    ('stdnoreturn.h', None, ''),
    ('string.h', None, 'size_t strlen(const char *str);\nchar *strncpy(char *strDest, const char *strSource, size_t count);\nchar *strcpy(char *strDestination, const char *strSource);'),
    ('strings.h', None, ''),
    ('stropts.h', None, ''),
    ('syslog.h', None, ''),
    ('tar.h', None, ''),
...
def run(temp_dir):
    ...
    for file, guard, file_data in lib_c_files:
